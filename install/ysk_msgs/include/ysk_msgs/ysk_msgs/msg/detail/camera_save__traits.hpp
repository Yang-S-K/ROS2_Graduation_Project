...
#ifndef YSK_MSGS__MSG__DETAIL__CAMERA_SAVE__TRAITS_HPP_
#define YSK_MSGS__MSG__DETAIL__CAMERA_SAVE__TRAITS_HPP_
...
inline void to_yaml(
  const ysk_msgs::msg::CameraSave & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ysk_msgs::msg::CameraSave & msg)
{
  return ysk_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<ysk_msgs::msg::CameraSave>()
{
  return "ysk_msgs::msg::CameraSave";
}

template<>
inline const char * name<ysk_msgs::msg::CameraSave>()
{
  return "ysk_msgs/msg/CameraSave";
}

template<>
struct has_fixed_size<ysk_msgs::msg::CameraSave>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<ysk_msgs::msg::CameraSave>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<ysk_msgs::msg::CameraSave>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // YSK_MSGS__MSG__DETAIL__CAMERA_SAVE__TRAITS_HPP_
