...
#ifndef YSK_MSGS__MSG__DETAIL__CAMERA_SAVE__STRUCT_HPP_
#define YSK_MSGS__MSG__DETAIL__CAMERA_SAVE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ysk_msgs__msg__CameraSave __attribute__((deprecated))
#else
# define DEPRECATED__ysk_msgs__msg__CameraSave __declspec(deprecated)
#endif
...
struct CameraSave_
{
  ...
  // pointer types
  using RawPtr =
    ysk_msgs::msg::CameraSave_<ContainerAllocator> *;
  using ConstRawPtr =
    const ysk_msgs::msg::CameraSave_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ysk_msgs::msg::CameraSave_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ysk_msgs::msg::CameraSave_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ysk_msgs::msg::CameraSave_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ysk_msgs::msg::CameraSave_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ysk_msgs::msg::CameraSave_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ysk_msgs::msg::CameraSave_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ysk_msgs::msg::CameraSave_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ysk_msgs__msg__CameraSave
    std::shared_ptr<ysk_msgs::msg::CameraSave_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ysk_msgs__msg__CameraSave
    std::shared_ptr<ysk_msgs::msg::CameraSave_<ContainerAllocator> const>
...
using CameraSave =
  ysk_msgs::msg::CameraSave_<std::allocator<void>>;
...
#endif  // YSK_MSGS__MSG__DETAIL__CAMERA_SAVE__STRUCT_HPP_
