...
#ifndef YSK_MSGS__SRV__DETAIL__OPEN_CV_INFO__FUNCTIONS_H_
#define YSK_MSGS__SRV__DETAIL__OPEN_CV_INFO__FUNCTIONS_H_
...
/// Initialize srv/OpenCvInfo message.
/**
...
/// Finalize srv/OpenCvInfo message.
/**
...
/// Create srv/OpenCvInfo message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ysk_msgs__srv__OpenCvInfo_Request__init().
...
/// Destroy srv/OpenCvInfo message.
/**
 * It calls
 * ysk_msgs__srv__OpenCvInfo_Request__fini()
...
/// Check for srv/OpenCvInfo message equality.
/**
...
/// Initialize array of srv/OpenCvInfo messages.
/**
...
/// Finalize array of srv/OpenCvInfo messages.
/**
 * It calls
 * ysk_msgs__srv__OpenCvInfo_Request__fini()
...
/// Create array of srv/OpenCvInfo messages.
/**
 * It allocates the memory for the array and calls
 * ysk_msgs__srv__OpenCvInfo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/OpenCvInfo messages.
/**
 * It calls
 * ysk_msgs__srv__OpenCvInfo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/OpenCvInfo message array equality.
/**
...
/// Copy an array of srv/OpenCvInfo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ysk_msgs__srv__OpenCvInfo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It calls
 * ysk_msgs__srv__OpenCvInfo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It allocates the memory for the array and calls
 * ysk_msgs__srv__OpenCvInfo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It calls
 * ysk_msgs__srv__OpenCvInfo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // YSK_MSGS__SRV__DETAIL__OPEN_CV_INFO__FUNCTIONS_H_
