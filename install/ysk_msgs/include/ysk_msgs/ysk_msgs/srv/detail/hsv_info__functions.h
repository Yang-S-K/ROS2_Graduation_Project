...
#ifndef YSK_MSGS__SRV__DETAIL__HSV_INFO__FUNCTIONS_H_
#define YSK_MSGS__SRV__DETAIL__HSV_INFO__FUNCTIONS_H_
 ...
 * calls
 * ysk_msgs__srv__HSVInfo_Request__init().
...
/**
 * It calls
 * ysk_msgs__srv__HSVInfo_Request__fini()
 ...
 * ysk_msgs__srv__HSVInfo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ysk_msgs__srv__HSVInfo_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ysk_msgs__srv__HSVInfo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It calls
 * ysk_msgs__srv__HSVInfo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It allocates the memory for the array and calls
 * ysk_msgs__srv__HSVInfo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It calls
 * ysk_msgs__srv__HSVInfo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // YSK_MSGS__SRV__DETAIL__HSV_INFO__FUNCTIONS_H_
