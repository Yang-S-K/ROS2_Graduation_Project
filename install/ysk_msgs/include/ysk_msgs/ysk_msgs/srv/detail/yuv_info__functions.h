...
#ifndef YSK_MSGS__SRV__DETAIL__YUV_INFO__FUNCTIONS_H_
#define YSK_MSGS__SRV__DETAIL__YUV_INFO__FUNCTIONS_H_
...
/// Initialize srv/YUVInfo message.
/**
...
/// Create srv/YUVInfo message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ysk_msgs__srv__YUVInfo_Request__init().
...
/// Destroy srv/YUVInfo message.
/**
 * It calls
 * ysk_msgs__srv__YUVInfo_Request__fini()
...
/// Check for srv/YUVInfo message equality.
/**
...
/// Initialize array of srv/YUVInfo messages.
/**
...
/// Finalize array of srv/YUVInfo messages.
/**
 * It calls
 * ysk_msgs__srv__YUVInfo_Request__fini()
...
/// Create array of srv/YUVInfo messages.
/**
 * It allocates the memory for the array and calls
 * ysk_msgs__srv__YUVInfo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/YUVInfo messages.
/**
 * It calls
 * ysk_msgs__srv__YUVInfo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/YUVInfo message array equality.
/**
...
/// Copy an array of srv/YUVInfo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ysk_msgs__srv__YUVInfo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It calls
 * ysk_msgs__srv__YUVInfo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It allocates the memory for the array and calls
 * ysk_msgs__srv__YUVInfo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ysk_msgs
...
/**
 * It calls
 * ysk_msgs__srv__YUVInfo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // YSK_MSGS__SRV__DETAIL__YUV_INFO__FUNCTIONS_H_
