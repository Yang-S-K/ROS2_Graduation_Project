...
class Metaclass_SaveHSV(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ysk_msgs.srv import _save_hsv
...
class SaveHSV(metaclass=Metaclass_SaveHSV):
    from ysk_msgs.srv._save_hsv import SaveHSV_Request as Request
    from ysk_msgs.srv._save_hsv import SaveHSV_Response as Response
