...
static const _SaveYUV_Request_type_support_symbol_names_t _SaveYUV_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ysk_msgs, srv, SaveYUV_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ysk_msgs, srv, SaveYUV_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ysk_msgs, srv, SaveYUV_Request)() {
  return &::ysk_msgs::srv::rosidl_typesupport_c::SaveYUV_Request_message_type_support_handle;
}
...
static const _SaveYUV_Response_type_support_symbol_names_t _SaveYUV_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ysk_msgs, srv, SaveYUV_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ysk_msgs, srv, SaveYUV_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ysk_msgs, srv, SaveYUV_Response)() {
  return &::ysk_msgs::srv::rosidl_typesupport_c::SaveYUV_Response_message_type_support_handle;
}
...
static const _SaveYUV_type_support_symbol_names_t _SaveYUV_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ysk_msgs, srv, SaveYUV)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ysk_msgs, srv, SaveYUV)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ysk_msgs, srv, SaveYUV)() {
  return &::ysk_msgs::srv::rosidl_typesupport_c::SaveYUV_service_type_support_handle;
}
