...
static const _HSVValue_type_support_symbol_names_t _HSVValue_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ysk_msgs, msg, HSVValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ysk_msgs, msg, HSVValue)),
  }
};
...
{
  return &::ysk_msgs::msg::rosidl_typesupport_cpp::HSVValue_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ysk_msgs, msg, HSVValue)() {
  return get_message_type_support_handle<ysk_msgs::msg::HSVValue>();
}
