...
#include "ysk_msgs/msg/detail/camera_save__rosidl_typesupport_fastrtps_c.h"
...
using _CameraSave__ros_msg_type = ysk_msgs__msg__CameraSave;
...
size_t get_serialized_size_ysk_msgs__msg__CameraSave(
  const void * untyped_ros_message,
...
static uint32_t _CameraSave__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ysk_msgs__msg__CameraSave(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ysk_msgs
size_t max_serialized_size_ysk_msgs__msg__CameraSave(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ysk_msgs__msg__CameraSave;
    is_plain =
      (
...
static size_t _CameraSave__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ysk_msgs__msg__CameraSave(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ysk_msgs, msg, CameraSave)() {
