...
#include "ysk_msgs/srv/detail/save_hsv__rosidl_typesupport_fastrtps_c.h"
...
using _SaveHSV_Request__ros_msg_type = ysk_msgs__srv__SaveHSV_Request;
...
size_t get_serialized_size_ysk_msgs__srv__SaveHSV_Request(
  const void * untyped_ros_message,
...
static uint32_t _SaveHSV_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ysk_msgs__srv__SaveHSV_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ysk_msgs
size_t max_serialized_size_ysk_msgs__srv__SaveHSV_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ysk_msgs__srv__SaveHSV_Request;
    is_plain =
      (
...
static size_t _SaveHSV_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ysk_msgs__srv__SaveHSV_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ysk_msgs, srv, SaveHSV_Request)() {
...
using _SaveHSV_Response__ros_msg_type = ysk_msgs__srv__SaveHSV_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ysk_msgs
size_t get_serialized_size_ysk_msgs__srv__SaveHSV_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SaveHSV_Response__ros_msg_type * ros_message = static_cast<const _SaveHSV_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ysk_msgs__srv__SaveHSV_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ysk_msgs
size_t max_serialized_size_ysk_msgs__srv__SaveHSV_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ysk_msgs__srv__SaveHSV_Response;
    is_plain =
      (
...
static size_t _SaveHSV_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ysk_msgs__srv__SaveHSV_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ysk_msgs, srv, SaveHSV_Response)() {
...
// already included above
// #include "ysk_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ysk_msgs/srv/save_hsv.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ysk_msgs, srv, SaveHSV)() {
