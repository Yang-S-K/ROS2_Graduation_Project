...
{
  new (message_memory) ysk_msgs::srv::SaveHSV_Request(_init);
}

void SaveHSV_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ysk_msgs::srv::SaveHSV_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveHSV_Request_message_member_array[2] = {
  {
    ...
    offsetof(ysk_msgs::srv::SaveHSV_Request, save),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ysk_msgs::srv::SaveHSV_Request, location),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveHSV_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(ysk_msgs::srv::SaveHSV_Request),
...
{
  return &::ysk_msgs::srv::rosidl_typesupport_introspection_cpp::SaveHSV_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ysk_msgs, srv, SaveHSV_Request)() {
  return &::ysk_msgs::srv::rosidl_typesupport_introspection_cpp::SaveHSV_Request_message_type_support_handle;
}
...
void SaveHSV_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) ysk_msgs::srv::SaveHSV_Response(_init);
}

void SaveHSV_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ysk_msgs::srv::SaveHSV_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveHSV_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ysk_msgs::srv::SaveHSV_Response, already),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveHSV_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(ysk_msgs::srv::SaveHSV_Response),
...
{
  return &::ysk_msgs::srv::rosidl_typesupport_introspection_cpp::SaveHSV_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ysk_msgs, srv, SaveHSV_Response)() {
  return &::ysk_msgs::srv::rosidl_typesupport_introspection_cpp::SaveHSV_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SaveHSV_service_members = {
  ...
  // see get_service_type_support_handle<ysk_msgs::srv::SaveHSV>()
...
get_service_type_support_handle<ysk_msgs::srv::SaveHSV>()
{
  ...
  auto service_type_support =
    &::ysk_msgs::srv::rosidl_typesupport_introspection_cpp::SaveHSV_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ysk_msgs, srv, SaveHSV)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<ysk_msgs::srv::SaveHSV>();
}
