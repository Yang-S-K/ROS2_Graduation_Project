...
#include "ysk_msgs/msg/detail/camera__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ysk_msgs::msg::Camera & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ysk_msgs::msg::Camera & ros_message)
{
  // Member: brightness
  cdr >> ros_message.brightness;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ysk_msgs::msg::Camera;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ysk_msgs::msg::Camera *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ysk_msgs::msg::Camera *>(
    untyped_ros_message);
...
{
  return &ysk_msgs::msg::typesupport_fastrtps_cpp::_Camera__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ysk_msgs, msg, Camera)() {
  return &ysk_msgs::msg::typesupport_fastrtps_cpp::_Camera__handle;
}
