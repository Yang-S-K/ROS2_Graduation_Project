...
#include "ysk_msgs/msg/detail/location__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ysk_msgs::msg::Location & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ysk_msgs::msg::Location & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ysk_msgs::msg::Location;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ysk_msgs::msg::Location *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ysk_msgs::msg::Location *>(
    untyped_ros_message);
...
{
  return &ysk_msgs::msg::typesupport_fastrtps_cpp::_Location__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ysk_msgs, msg, Location)() {
  return &ysk_msgs::msg::typesupport_fastrtps_cpp::_Location__handle;
}
