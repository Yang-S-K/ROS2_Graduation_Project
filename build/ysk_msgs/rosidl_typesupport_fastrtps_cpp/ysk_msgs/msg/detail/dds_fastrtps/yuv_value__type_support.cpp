...
#include "ysk_msgs/msg/detail/yuv_value__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ysk_msgs::msg::YUVValue & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ysk_msgs::msg::YUVValue & ros_message)
{
  // Member: ymin
  cdr >> ros_message.ymin;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ysk_msgs::msg::YUVValue;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ysk_msgs::msg::YUVValue *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ysk_msgs::msg::YUVValue *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _YUVValue__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ysk_msgs::msg::YUVValue *>(
...
static size_t _YUVValue__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_YUVValue(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _YUVValue__callbacks = {
  "ysk_msgs::msg",
  "YUVValue",
...
static rosidl_message_type_support_t _YUVValue__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_YUVValue__callbacks,
...
{
  return &ysk_msgs::msg::typesupport_fastrtps_cpp::_YUVValue__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ysk_msgs, msg, YUVValue)() {
  return &ysk_msgs::msg::typesupport_fastrtps_cpp::_YUVValue__handle;
}
